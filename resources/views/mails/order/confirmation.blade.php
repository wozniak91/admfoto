...
<div class="content">
    ...
    <h1 class="heading">Potwierdzenie zamówienia nr #{{ $order->id }}</h1>

    <div class="content-body">
        <p class="lead">Dziękujemy {{ ucfirst($order->firstname) }}! Twoje zamówienie zostało złożone.</p>
        ...
        <table class="table">
            <tbody>
                <tr class="tr">
                    ...
                    <td class="td">
                        <div class="card">
                            <h2 class="card-title">Punkt odbioru</h2>
                            <p class="card-text">FotoAdamski</p>
                            <p class="card-text">Sklep i Zakład Fotografczny</p>
                            <p class="card-text">ul. Poniatowskiego 22</p>
                            <p class="card-text">63-600 - Kępno</p>
                        </div>
                    </td>
                </tr>
            </tbody>
